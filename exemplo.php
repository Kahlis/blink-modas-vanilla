<?php
	...
	$credenciais = array(
	    	"email" => "kahlis.dev@gmail.com",
			"token" => "8E5B7CC33812447ABFD8163ADA6E67DB"
	);
	$curl = curl_init($url);
...
<body>
	...
	<button  class="btn btn-info" id="buy">Comprar</button>
</body>
...
<script type="text/javascript">
	...
	$("#buy").click(function(){
		$.ajax({
			method: "POST",
			url: "https://ws.sandbox.pagseguro.uol.com.br/v2/transactions?email=kahlis.dev@gmail.com&token=8E5B7CC33812447ABFD8163ADA6E67DB",
